 ...
 * @author Nam
 */
public class AddGuestPanel extends javax.swing.JPanel {
    ...
    public void themKhach()
    {
        if(check())
        {
            dto = new KhachHangDTO(tenTxt.getText(), sdtTxt.getText(), ngaysinhTxt.getText(), emailTxt.getText(), cmndTxt.getText(),
                    ghichuTxt.getText());
            bll.themKhach(dto);
            JOptionPane.showMessageDialog(null, "Thêm hành khách thành công");
    ...
    public boolean check()
    {
        ...
        if(cmndTxt.getText().equals(""))
        {
            ...
            cmndErr.setText("Khách hàng có CMND này đã tồn tại");
            check = false;
        } else {
            cmndErr.setText("");
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, -1, 30));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, -1, 30));
