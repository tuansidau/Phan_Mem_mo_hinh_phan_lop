 ...
 * @author Nam
 */
public class AddChiphiDoanPanel extends javax.swing.JPanel {
    ...
    public void themChiphi()
    {
        ...
        bll.themChiphi(dto);
        doanBll.suaTrangthai(currentDoan_id);
...
class Remove extends AbstractCellEditor implements TableCellRenderer,TableCellEditor,ActionListener{
    ...
    private void initComponents() {
        ...
        jLabel5.setText("NHẬP CHI PHÍ CHUYẾN ĐI TOUR");
