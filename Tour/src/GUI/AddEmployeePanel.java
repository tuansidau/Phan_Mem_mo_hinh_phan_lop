...
public class AddEmployeePanel extends javax.swing.JPanel {
    ...
    public void init()
    {
        ...
        dsnhiemvuTable.getColumnModel().getColumn(2).setCellEditor(new Add());
        dsnhiemvuTable.getColumnModel().getColumn(2).setCellRenderer(new Add());
        dsnhiemvuTable.getColumnModel().getColumn(2).setPreferredWidth(40);
        dsnhiemvuTable.getColumnModel().getColumn(0).setPreferredWidth(40);
        dsnhiemvuTable.getColumnModel().getColumn(1).setPreferredWidth(220);
        ...
        nhiemvuTable.getColumnModel().getColumn(2).setCellEditor(new Remove());
        nhiemvuTable.getColumnModel().getColumn(2).setCellRenderer(new Remove());
        nhiemvuTable.getColumnModel().getColumn(2).setPreferredWidth(40);
        nhiemvuTable.getColumnModel().getColumn(0).setPreferredWidth(40);
        nhiemvuTable.getColumnModel().getColumn(1).setPreferredWidth(220);
    ...
    public void themNhanvien()
    {
        if(check())
        {
            dto = new NhanvienDTO(tenTxt.getText(), sdtTxt.getText(), ngaysinhTxt.getText(), emailTxt.getText(), getNhiemvu());
            bll.themNhanvien(dto);
    ...
    public String getNhiemvu()
    {
        ...
        if(rows != 0)
        {
            ...
            {
                res += nhiemvuTable.getValueAt(num, 1) + ",";                    
            }
        }                   
        return res;
    }
        ...
        removebtn.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                try
                {
                    ...
                    row.add(nhiemvuTable.getValueAt(i, 1));
                    modelDs.addRow(row);
                    dsnhiemvuTable.setModel(modelDs);
...
class Add extends AbstractCellEditor implements TableCellRenderer,TableCellEditor,ActionListener{
        ...
        addbtn.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                try
                {
                    ...
                    row.add(dsnhiemvuTable.getValueAt(i, 1));
                    model.addRow(row);
                    nhiemvuTable.setModel(model);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICON/icons8-add-30.png"))); // NOI18N
